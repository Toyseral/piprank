...
for(const p of ['/forex-brokers-for-beginners','/mt4-forex-brokers','/mt5-forex-brokers','/gold-forex-brokers'])if(!app.includes(`path=\"${p}\"`))throw new Error(`Missing canonical route ${p}`);
const seo=read('src/lib/seo.ts');
for(const s of ["beginners: 'forex-brokers-for-beginners'","mt4: 'mt4-forex-brokers'","mt5: 'mt5-forex-brokers'","gold: 'gold-forex-brokers'"])if(!seo.includes(s))throw new Error(`Missing canonical SEO mapping ${s}`);
