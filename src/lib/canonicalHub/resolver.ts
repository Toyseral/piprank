...
export async function resolveCanonicalPath(pathname: string): Promise<CanonicalRoute | null> {
  ...
  // /countries/:slug is a legacy country URL. Country hubs canonically live at /:slug.
  ...
  // Country guides have an explicit /guides/ namespace. This check must run before all generic 3-segment routes.
  ...
  // The only owner of /:country/:slug is a published country Best-For document.
