...
import { canonicalKeyForDocument, canonicalPathForDocument, encodeSegment, localeOf } from '../canonical-route-registry.mjs';
...
export function canonicalCountryGuidePath(countrySlug: string, slug: string): string { return `/${encode(countrySlug)}/guides/${encode(slug)}`; }export { canonicalPathForDocument, canonicalKeyForDocument } from '../canonical-route-registry.mjs';
