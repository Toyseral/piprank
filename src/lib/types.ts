...
export interface BrokerContent { broker_id: number; overview?: string[]; verdict?: string[]; why_recommend?: string[]; best_for_detail?: string[]; avoid_if?: string[]; regulation_detail?: string[]; fees_detail?: string[]; platform_intro?: string[]; accounts_intro?: string[]; funding_intro?: string[]; faqs?: FAQ[]; platforms: PlatformDetail[]; accounts: AccountType[]; payments: PaymentRail[]; updated_at?: string; }
