...
import type { BrokerMatchAnswers as Answers, BrokerMatchQuestion as Question } from '../lib/brokerMatcher';
import { BROKER_MATCH_QUESTIONS as QUESTIONS, BROKER_MATCH_STEP_LABELS as STEP_COLS, BROKER_MATCH_LOADER_LINES as LOADER_LINES, scoreBroker } from '../lib/brokerMatcher';
  ...
  const results = useMemo(() => {
    ...
    return pool
      .map((b) => {
        ...
        const rank = country ? (availableOrder.get(b.slug) ?? 99) : 99;
