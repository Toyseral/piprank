...
export default function LocalizationWorkspace({ countries, languages, pages: _pages, contentDocs, mutate, accessToken: _accessToken }: {
  ...
  return <div className="space-y-6">
    ...
    {section === 'guides'
      ? <LocalizedGuidesManager countries={countries} languages={languages} contentDocs={contentDocs} mutate={mutate} accessToken={_accessToken}/>
      : <LocalizationManager countries={countries} languages={languages} contentDocs={contentDocs} mutate={mutate}/>} 
  </div>;
}