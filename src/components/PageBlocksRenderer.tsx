...
import StructuredBrokerDataCard, { type StructuredBrokerSection } from './StructuredBrokerDataCard';
    ...
    <div className={className}>
      {normalized.map((block, index) => {
        if (block.type === 'structured_broker_data') {
          ...
          return <StructuredBrokerDataCard key={block.id || index} broker={broker} section={(block.section || 'overview') as StructuredBrokerSection} />;
        }
