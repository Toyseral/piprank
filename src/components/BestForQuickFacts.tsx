...
export default function BestForQuickFacts({ broker }: { broker: Broker }) {
  ...
  return (
    <section className="-mt-7 w-full overflow-hidden border border-white/10 bg-ink-950 text-white shadow-soft sm:mt-0 sm:rounded-2xl" aria-label={`${broker.name} quick facts`}>
